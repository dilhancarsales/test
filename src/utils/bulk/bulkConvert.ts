...
export async function bulkConvert(gm: Graphics, source: string, filePath: string, pageNumber: number | number[] = 1, toBase64 = false): Promise<WriteImageResponse[] | ToBase64Response[]> {
